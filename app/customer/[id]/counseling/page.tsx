...
const FRONT_POINTS: BodyPoint[] = [
  ...
  { key: "front_left_shoulder", label: "左肩", left: "36%", top: "20%", size: 16 },
  { key: "front_right_shoulder", label: "右肩", left: "64%", top: "20%", size: 16 },
  { key: "front_chest", label: "胸", left: "50%", top: "25%" },
  { key: "front_left_upper_arm", label: "左二の腕", left: "24%", top: "28%" },
  { key: "front_right_upper_arm", label: "右二の腕", left: "76%", top: "28%" },
  { key: "front_left_elbow", label: "左肘", left: "18%", top: "40%" },
  { key: "front_right_elbow", label: "右肘", left: "82%", top: "40%" },
  { key: "front_left_wrist", label: "左手首", left: "15%", top: "52%" },
  { key: "front_right_wrist", label: "右手首", left: "85%", top: "52%" },
  { key: "front_abdomen", label: "お腹", left: "50%", top: "38%" },
  { key: "front_pelvis", label: "骨盤", left: "50%", top: "48%" },
  { key: "front_left_hip", label: "左股関節", left: "40%", top: "54%" },
  { key: "front_right_hip", label: "右股関節", left: "60%", top: "54%" },
  { key: "front_left_thigh", label: "左太もも前", left: "44%", top: "64%" },
  { key: "front_right_thigh", label: "右太もも前", left: "56%", top: "64%" },
  { key: "front_left_knee", label: "左膝", left: "45%", top: "78%" },
  { key: "front_right_knee", label: "右膝", left: "55%", top: "78%" },
  { key: "front_left_calf", label: "左ふくらはぎ", left: "45%", top: "89%" },
  { key: "front_right_calf", label: "右ふくらはぎ", left: "55%", top: "89%" },
  { key: "front_left_ankle", label: "左足首", left: "45%", top: "97%" },
  { key: "front_right_ankle", label: "右足首", left: "55%", top: "97%" },
];

const BACK_POINTS: BodyPoint[] = [
  { key: "back_neck", label: "首", left: "50%", top: "15%" },
  { key: "back_left_shoulder", label: "左肩", left: "36%", top: "20%", size: 16 },
  { key: "back_right_shoulder", label: "右肩", left: "64%", top: "20%", size: 16 },
  { key: "back_upper_back", label: "背中上部", left: "50%", top: "28%" },
  { key: "back_left_upper_arm", label: "左二の腕", left: "24%", top: "28%" },
  { key: "back_right_upper_arm", label: "右二の腕", left: "76%", top: "28%" },
  { key: "back_left_elbow", label: "左肘", left: "18%", top: "40%" },
  { key: "back_right_elbow", label: "右肘", left: "82%", top: "40%" },
  { key: "back_left_wrist", label: "左手首", left: "15%", top: "52%" },
  { key: "back_right_wrist", label: "右手首", left: "85%", top: "52%" },
  { key: "back_mid_back", label: "背中下部", left: "50%", top: "40%" },
  { key: "back_lower_back", label: "腰", left: "50%", top: "48%" },
  { key: "back_left_hip", label: "左お尻", left: "42%", top: "56%" },
  { key: "back_right_hip", label: "右お尻", left: "58%", top: "56%" },
  { key: "back_left_pelvis", label: "骨盤", left: "46%", top: "52%" },
  { key: "back_right_pelvis", label: "骨盤", left: "54%", top: "52%" },
  { key: "back_left_thigh", label: "左太もも裏", left: "44%", top: "66%" },
  { key: "back_right_thigh", label: "右太もも裏", left: "56%", top: "66%" },
  { key: "back_left_knee", label: "左膝", left: "45%", top: "78%" },
  { key: "back_right_knee", label: "右膝", left: "55%", top: "78%" },
  { key: "back_left_calf", label: "左ふくらはぎ", left: "45%", top: "89%" },
  { key: "back_right_calf", label: "右ふくらはぎ", left: "55%", top: "89%" },
  { key: "back_left_ankle", label: "左足首", left: "45%", top: "97%" },
  { key: "back_right_ankle", label: "右足首", left: "55%", top: "97%" },
];
  ...
  return (
    <div style={bodyFigureCardStyle}>
      ...
      <div style={bodyFigureTextStyle}>
        右だけ・左だけを別々に選択できます。もう一度タップで解除できます。
      </div>
    </div>
  );
}
